...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto py-10 px-4">
        ...
        <form action="{{route('homeworks.store', $TeacherId)}}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md px-6 py-8 space-y-6">
            ...
            <span class="text-danger"> @error('title_homework') {{"* ".$message}} @enderror </span>
            ...
            <span class="text-danger"> @error('content_homework') {{"* ".$message}} @enderror </span>
            ...
            <span class="text-danger"> @error('homework_mark') {{"* ".$message}} @enderror </span>
            ...
            <span class="text-danger"> @error('deadline_homework') {{"* ".$message}} @enderror </span>
            ...
            <span class="text-danger"> @error('file_homework') {{"* ".$message}} @enderror </span>
