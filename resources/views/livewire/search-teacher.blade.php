    ...
    <div class="overflow-x-auto w-full max-w-6xl bg-white rounded-2xl shadow-md border border-gray-200">
        <table class="min-w-full border-collapse text-sm md:text-base">
            ...
            <tbody class="divide-y divide-gray-200 text-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-3 px-4">
                            <div class="flex justify-center gap-2">
                                <a
                                    href="{{route('admin.teacher.edit',$teacher->user->id)}}"
                                ...
                                <form
                                    action="{{route('admin.teacher.trash',$teacher->user->id)}}"
                                    method="POST"
                ...
                @empty
                    <tr>
                        <td colspan="6" class="py-4 text-center text-red-500 font-medium">
