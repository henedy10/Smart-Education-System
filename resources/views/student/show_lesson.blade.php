        ...
        @forelse ( $lessons as $lesson )
                ...
                <div class="bg-white p-5 rounded-xl shadow hover:shadow-lg transition border-r-4 border-blue-500">
                    ...
                    <div class="flex gap-2">
                        <a href="{{asset('storage/'.$lesson->file_lesson)}}" target="_blank" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 text-sm">{{__('messages.show')}}</a>
                        <a href="{{asset('storage/'.$lesson->file_lesson)}}" download class="bg-gray-200 text-gray-800 px-3 py-1 rounded hover:bg-gray-300 text-sm">{{__('messages.upload')}}</a>
                    </div>
                </div>
        @empty
